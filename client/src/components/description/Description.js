...
export default function Description() {
  return (
    <div className='bottomDescripions'>
    ...
    <div className='bottomDescriptionsOverview'>
      <h3 className='bottomDescriptionsTitle'>Overview</h3>
      <p className='bottomDescripionsText'>
      Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model s entence structures,
      </p>
    </div>
